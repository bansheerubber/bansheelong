...
impl<Renderer: text::Renderer> Calendar<Renderer> {
	pub fn new(io: Option<Rc<IO>>) -> Self {
		Self {
	...
	Renderer: text::Renderer,
{
	...
	fn draw(
		...
		// test
		{
			let start_time = time_to_position(11, 0) + ITEM_MARGIN_LEFT;
			let end_time = time_to_position(14, 30) + ITEM_MARGIN_LEFT;
			...
			let mut string = String::from("this is a pretty long todo item that should be truncated heh eheh eheho ho hooh ohho jfadsaj fdkj jkfdsajiufj");
